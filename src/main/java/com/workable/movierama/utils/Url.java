...
public final class Url {
	...
	public final static String TMDB_SEARCH="https://api.themoviedb.org/3/search/movie?query={query}&api_key=186b266209c2da50f898b7977e2a44dd"	;	
	public final static String RT_REVIEWS = "http://api.rottentomatoes.com/api/public/v1.0/movies/{id}/reviews.json?apikey=qtqep7qydngcc7grk4r4hyd9";
	public final static String TMDB_MOVIE= "https://api.themoviedb.org/3/movie/{id}?api_key=186b266209c2da50f898b7977e2a44dd&append_to_response=overview,reviews,credits";
}
